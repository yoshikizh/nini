class SceneExample012 extends SceneBase {
  constructor(){
  ...
  update(){
    ...
    for ( let i = 0; i < 9; i++ ) {
      ...
      let dw = ( Graphics.width / 2 - 20 - 32) / 3
      let dh = ( Graphics.height - 20) / 3

      let src_rect = new Rect(rw*c2,rh*c1,rw,rh)
      let dest_rect = new Rect(offset_x + (dw + 10)*c2, offset_y + (dh + 10)*c1, dw, dh )

      this.sp2.bitmap.stretchBltImage(this.sp.bitmap , src_rect, dest_rect)
    }
